...
fun PageContent(
    ...
    val dummyText = "Use System Prompts:\n" +
            "\n" +
...
//                .fillMaxWidth(),
            ...
            EditTextField(
                ...
                onValueChange = { text ->
                    essayViewModel.essayTopic = text
                },
                value = essayViewModel.essayTopic,
                label = inputLabel,
            )
        }
        Spacer(modifier = Modifier.height(30.dp))
        ...
        ElevatedCard(
            modifier = Modifier
                ...
                .clickable {
                    ...
                    onGenerateClick(essayViewModel.essayTopic)
                },
...
//                color = Color.White,
        ...
        // TODO: remove
        Text(text = essayViewModel.essayTopic)
    }
}
...
//                .fillMaxWidth(),
            ...
            EditTextField(
                modifier = Modifier.fillMaxWidth(),
                onValueChange = { text ->
                    viewModel.articleTopic = text
                },
                value = viewModel.articleTopic,
                label = inputLabel,
            )
        }
        Spacer(modifier = Modifier.height(30.dp))
...
//                color = Color.White,
        ...
        // TODO: remove
        Text(text = viewModel.articleTopic)
    }
}
...
//                .fillMaxWidth(),
            ...
            EditTextField(
                modifier = Modifier.fillMaxWidth(),
                onValueChange = { text ->
                    emailViewModel.emailTopic = text
                },
                value = emailViewModel.emailTopic,
                label = topicLabel,
            )
            ...
            EditTextField(
                modifier = Modifier.fillMaxWidth(),
                onValueChange = { text ->
                    emailViewModel.emailDestination = text
                },
                value = emailViewModel.emailDestination,
                label = toLabel,
            )
        }
        Spacer(modifier = Modifier.height(30.dp))
...
//                color = Color.White,
            ...
            text = emailViewModel.EmailResponse
        )
    }
}
